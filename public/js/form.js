...
const VALUE_DRIVERS = [
  { id: 'safety',     name: 'Safety',              desc: 'Injuries, OSHA recordables, ergonomic risk' },
  { id: 'labor',      name: 'Labor savings',       desc: 'Hard-to-fill positions, overtime spend' },
  { id: 'throughput', name: 'Throughput',          desc: 'Cycle time, parts per shift, OEE' },
  { id: 'downtime',   name: 'Costly downtime',     desc: 'Unplanned stops, MTBF' },
  { id: 'quality',    name: 'Quality & rework',    desc: 'Scrap, defects, customer returns' },
  { id: 'leadtime',   name: 'Lead time',           desc: 'Time-to-ship, on-time delivery' },
  { id: 'ergonomics', name: 'Ergonomics',          desc: 'Repetitive motion, lifting strain, MSDs' },
  { id: 'compliance', name: 'Compliance',          desc: 'OSHA, UL/cUL, FDA, audit readiness' },
  { id: 'energy',     name: 'Energy efficiency',   desc: 'Power draw, HPU cooling, idle load' },
  { id: 'floorspace', name: 'Floor space',         desc: 'Footprint, layout, expansion limits' },
  { id: 'retention',  name: 'Skilled-labor retention', desc: 'Turnover, recruiting cost' },
  { id: 'insurance',  name: 'Workers comp / insurance', desc: 'Premium loading, mod rate' },
];
...
const SECTIONS = [
  {
    ...
    subslides: [
      { num: 4, title: 'A Legacy of Innovation and Trust Since 1948', desc: 'Origin story — Roger & Doris Scott, Dayton OH, 1948' },
      { num: 5, title: 'A Legacy of Innovation and Trust Since 1948 (cont.)', desc: 'Today — automation, assembly machines, team photo' },
    ],
  },
  {
    id: 'capabilities',
    ...
    subslides: [
      { num: 6, title: 'A Full-Service Integrator', desc: 'Single-source partner overview, 8 service pills' },
      { num: 7, title: 'Built for Any Challenge', desc: 'Concept to completion, full capability list' },
      { num: 8, title: 'Solutions for Your Market & Business', desc: 'Industries served — automotive, F&B, energy, etc.' },
      { num: 9, title: 'Manufacturing Partners', desc: 'Robotic + control equipment supplier logos' },
      { num: 10, title: 'Automation Systems', desc: 'Consult / engineer / design overview & offerings' },
    ],
  },
  {
    id: 'previousProjects',
  ...
  },
  {
    ...
    subslides: [
      { num: 22, title: 'Custom Hydraulic Motion Control Systems', desc: 'Overview — retrofit, upgrade, replace; 3D CAD' },
      { num: 23, title: 'Configurable HPUs — Sizing & Flow', desc: '1–30 gpm, up to 50 HP, 10–80 gal, 3,000 psi' },
      { num: 24, title: 'Configurable HPUs — Services Offered', desc: 'Configurator, drawings, schematics, QR code' },
      { num: 25, title: 'Configurable HPUs — Standard Features & Competition', desc: 'Standard features; competition' },
    ],
  },
  {
    id: 'controls',
    ...
    subslides: [
      { num: 26, title: 'Industrial Custom Control Systems', desc: 'Control systems/packages/panels; cUL/UL 508A & 698A' },
      { num: 27, title: 'Industrial Custom Control Systems (detail)', desc: 'Reliability, customization, safety, service & support' },
      { num: 28, title: 'Motor Control Centers (MCC)', desc: '100% SCOTT-designed; VFD, PLCs, HMI packages' },
      { num: 29, title: 'Configurable Motor Starter Control Packages', desc: 'Up to 4 motors, overload & surge protection' },
      { num: 30, title: 'Motor Starter Control Packages — Overview & Options', desc: 'Voltage, enclosure, advantages, design options' },
    ],
  },
  {
    id: 'engineered',
    ...
    subslides: [
      { num: 31, title: 'Engineered Expertise — Tools', desc: 'ePlan & AutoCAD, CNC, wire processing, ERP' },
      { num: 32, title: 'Engineered Expertise — Team', desc: '7 Controls, 8 Electrical, 8 Mech engineers; 400+ yrs' },
    ],
  },
  {
    id: 'testStands',
    ...
    subslides: [
      { num: 33, title: 'Testing Capabilities — Motor / Cast Iron Pump / Aluminum Pump', desc: 'Flow, PSI, HP, RPM specs' },
      { num: 34, title: 'Testing Capabilities — Pump & Manifold Test Stands', desc: 'VFD, HMI, contamination monitoring' },
    ],
  },
  {
    id: 'realResults',
...
const PROJECTS = [
  { id: 'p11', tag: 'Automation Systems', title: 'Aluminum Manufacturer — Machine Tending', sub: '9 mo · 4× Kuka · Allen Bradley · MCS conveyors' },
  { id: 'p12', tag: 'Automation Systems', title: 'Automated Deburring Cell',                  sub: '6 mo · 2× Motoman · Mitsubishi' },
  { id: 'p13', tag: 'Automotive',         title: 'Mission Case Bearing Press',                sub: '4 mo · Mitsubishi · custom tooling' },
  { id: 'p14', tag: 'Truck Mfg',          title: 'Glue Application System',                   sub: '6 mo · Kuka · Allen Bradley' },
  { id: 'p15', tag: 'Appliance',          title: 'Gear Case Machining Line',                  sub: '12 mo · 10× Kuka · 4 drilling stations' },
  { id: 'p16', tag: 'Automotive',         title: 'Radiator Assembly Cell',                    sub: '9 mo · 2× Kuka · feeder bowls' },
  { id: 'p17', tag: 'Automotive',         title: 'Valve Cover Quality Tester',                sub: '4 mo · Omron · custom tooling' },
  { id: 'p18', tag: 'Medical Device',     title: 'Positive Battery Contact Assembly',         sub: 'Custom-built · spring staking' },
  { id: 'p19', tag: 'Machine Tool',       title: 'Induction Hardening Tend & Test',           sub: 'Tending · Eddy current · laser marking' },
  { id: 'p20', tag: 'Medical Device',     title: 'Packing Nut Assembly & Packaging',          sub: 'Bulk feed · 0.8 sec cycle' },
  { id: 'p21', tag: 'Aerospace',          title: 'Auto Bellows Forming Machine',              sub: '¾"–10" O.D. · multi-program convolutes' },
];
...
function renderProjects() {
  ...
  grid.addEventListener('change', e => {
    if (e.target.matches('input[name="project"]')) {
      e.target.closest('.proj').classList.toggle('checked', e.target.checked);
    }
    updateSummary();
  });
}
...
function addProposal() {
  ...
  card.querySelectorAll('.media-tab').forEach(tab => {
    tab.addEventListener('click', () => {
      ...
      card.querySelectorAll('.media-tab').forEach(t => t.classList.toggle('active', t === tab));
      card.querySelectorAll('.media-pane').forEach(p => p.classList.toggle('active', p.dataset.kind === targetKind));
  ...
  function handleMediaFile(file) {
    ...
    const reader = new FileReader();
    reader.onload = (e) => {
      proposalMediaState[id] = { kind: 'image', file, dataUrl: e.target.result };
  ...
  card.addEventListener('dragend', () => {
    ...
    document.querySelectorAll('.proposal-card').forEach(c => c.classList.remove('drag-over'));
    renumberProposals();
  });
...
function wireUpEvents() {
  ...
  document.addEventListener('click', e => {
    if (e.target.matches('.expand-btn')) {
      const panel = document.getElementById(`sub-${e.target.dataset.toggle}`);
      if (!panel) return;
  ...
  document.addEventListener('change', e => {
    if (e.target.matches('.sec-master')) {
      ...
      document.querySelectorAll(`.sub-cb[data-parent="${id}"]`).forEach(s => {
    ...
    if (e.target.matches('.sub-cb')) {
      ...
      const siblings = document.querySelectorAll(`.sub-cb[data-parent="${id}"]`);
      const anyChecked = Array.from(siblings).some(s => s.checked);
      const master = document.querySelector(`.sec-master[data-section="${id}"]`);
      master.checked = anyChecked;
      master.closest('.section-block').classList.toggle('disabled', !anyChecked);
      updateSummary();
    }
  });
  ...
  // Add proposal slide
  document.getElementById('addProposalBtn').addEventListener('click', addProposal);

  // Form submit
  document.getElementById('deckForm').addEventListener('submit', handleSubmit);
}
...
function updateSummary() {
  ...
  const tags = document.querySelectorAll('input[name="valueDriver"]:checked').length;
  ...
  const prevMaster = document.querySelector('.sec-master[data-section="previousProjects"]');
  if (prevMaster && prevMaster.checked) {
    total += document.querySelectorAll('input[name="project"]:checked').length;
  }
  // Real Results (single-slide section)
  const realMaster = document.querySelector('.sec-master[data-section="realResults"]');
...
async function handleSubmit(e) {
  ...
  const activeMode = document.getElementById('segName').classList.contains('active') ? 'name' : 'logo';
  ...
  try {
    ...
    const safeName = (customerName || 'Customer').replace(/[^a-zA-Z0-9_-]+/g, '_') || 'Customer';
...
function collectMetadata(customerMode, customerName) {
  ...
  const sectionsData = {};
  SECTIONS.forEach(sec => {
    const master = document.querySelector(`.sec-master[data-section="${sec.id}"]`);
    sectionsData[sec.id] = {
      enabled: master ? master.checked : false,
      subslides: sec.subslides
        ? Array.from(document.querySelectorAll(`.sub-cb[data-parent="${sec.id}"]:checked`)).map(cb => parseInt(cb.dataset.slide, 10))
        : null,
    };
  });
  ...
  document.querySelectorAll('.proposal-card').forEach((card, i) => {
    ...
    const title = card.querySelector('input[name="proposalTitle[]"]').value.trim();
    const body = card.querySelector('textarea[name="proposalBody[]"]').value.trim();
    proposals.push({
      title,
      body,
  ...
  return {
    ...
    customerLogoFilename: customerMode === 'logo' ? customerLogoFilename : '',
    painPoint: fd.get('painPoint') || '',
    valueDrivers: fd.getAll('valueDriver'),
    successState: fd.get('successState') || '',
    plan: {
      step1: { title: fd.get('step1Title') || '', body: fd.get('step1Body') || '' },
      step2: { title: fd.get('step2Title') || '', body: fd.get('step2Body') || '' },
      step3: { title: fd.get('step3Title') || '', body: fd.get('step3Body') || '' },
    },
